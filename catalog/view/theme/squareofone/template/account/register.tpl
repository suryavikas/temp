  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="content">
        ...
        <tr>
          ...
          <td><input type="password" name="confirm" value="<?php echo $confirm; ?>" class="inpt" />
    ...
    <div class="content">
        ...
        <tr id="company-id-display">
          ...
          <td><input type="text" name="company_id" value="<?php echo $company_id; ?>" class="inpt" />
        ...
        <tr id="tax-id-display">
          ...
          <td><input type="text" name="tax_id" value="<?php echo $tax_id; ?>" class="inpt" />
            <?php if ($error_tax_id) { ?>
        ...
        <tr>
          ...
          <td><input type="text" name="address_1" value="<?php echo $address_1; ?>" class="inpt" />
        ...
        <tr>
          ...
          <td><input type="text" name="address_2" value="<?php echo $address_2; ?>" class="inpt" /></td>
        </tr>
        <tr>
          <td><span class="required">*</span> <?php echo $entry_city; ?></td>
          <td><input type="text" name="city" value="<?php echo $city; ?>" class="inpt" />
            <?php if ($error_city) { ?>
        ...
        <tr>
          ...
          <td><input type="text" name="postcode" value="<?php echo $postcode; ?>" class="inpt" />
        ...
        <tr>
          ...
          <td><select name="country_id" class="sltt">
